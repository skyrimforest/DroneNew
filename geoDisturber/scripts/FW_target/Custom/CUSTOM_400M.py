...
import CUSTOM_400M_change_sink as change_sink  # embedded python module
import CUSTOM_400M_receive_para as receive_para  # embedded python module
import time
import threading
...
class CUSTOM_400M(gr.top_block):

    def __init__(self, END_1=455000000, START_1=415000000, uri='192.168.1.7'):
        gr.top_block.__init__(self, "CUSTOM_400M", catch_exceptions=True)
        ...
        # Variables
        ##################################################
        self.default = default = 895000000
...
def argument_parser():
    ...
    parser.add_argument(
        "--END-1", dest="END_1", type=intx, default=455000000,
        help="Set END_1 [default=%(default)r]")
    parser.add_argument(
        "--START-1", dest="START_1", type=intx, default=415000000,
...
def main(top_block_cls=CUSTOM_400M, options=None):
    if options is None:
