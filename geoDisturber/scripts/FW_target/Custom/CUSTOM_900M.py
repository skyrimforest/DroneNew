...
import CUSTOM_900M_change_sink as change_sink  # embedded python module
import CUSTOM_900M_receive_para as receive_para  # embedded python module
import time
import threading
...
class CUSTOM_900M(gr.top_block):

    def __init__(self, END_1=955000000, START_1=835000000, uri='192.168.1.7'):
        gr.top_block.__init__(self, "CUSTOM_900M", catch_exceptions=True)
        ...
        # Variables
        ##################################################
        self.default = default = 430000000
...
def argument_parser():
    ...
    parser.add_argument(
        "--END-1", dest="END_1", type=intx, default=955000000,
        help="Set END_1 [default=%(default)r]")
    parser.add_argument(
        "--START-1", dest="START_1", type=intx, default=835000000,
...
def main(top_block_cls=CUSTOM_900M, options=None):
    if options is None:
