...
import CUSTOM_1500M_change_sink as change_sink  # embedded python module
import CUSTOM_1500M_receive_para as receive_para  # embedded python module
import time
import threading
...
class CUSTOM_1500M(gr.top_block):

    def __init__(self, END_1=1630000000, START_1=1480000000, uri='192.168.1.11'):
        gr.top_block.__init__(self, "CUSTOM_1500M", catch_exceptions=True)
        ...
        # Variables
        ##################################################
        self.default = default = 1435000000
...
def main(top_block_cls=CUSTOM_1500M, options=None):
    if options is None:
