...
import CUSTOM_5800M_change_sink as change_sink  # embedded python module
import CUSTOM_5800M_receive_para as receive_para  # embedded python module
import time
import threading
...
class CUSTOM_5800M(gr.top_block):

    def __init__(self, END_1=5870000000, START_1=5715000000, uri='192.168.1.12'):
        gr.top_block.__init__(self, "CUSTOM_5800M", catch_exceptions=True)
        ...
        # Variables
        ##################################################
        self.default = default = 5250000000
...
def main(top_block_cls=CUSTOM_5800M, options=None):
    if options is None:
