...
import CUSTOM_1400M_change_sink as change_sink  # embedded python module
import CUSTOM_1400M_receive_para as receive_para  # embedded python module
import time
import threading
...
class CUSTOM_1400M(gr.top_block):

    def __init__(self, END_1=1455000000, START_1=1415000000, uri='192.168.1.11'):
        gr.top_block.__init__(self, "CUSTOM_1400M", catch_exceptions=True)
        ...
        # Variables
        ##################################################
        self.default = default = 1555000000
...
def argument_parser():
    ...
    parser.add_argument(
        "--END-1", dest="END_1", type=intx, default=1455000000,
        help="Set END_1 [default=%(default)r]")
    parser.add_argument(
        "--START-1", dest="START_1", type=intx, default=1415000000,
...
def main(top_block_cls=CUSTOM_1400M, options=None):
    if options is None:
