...
import CUSTOM_5800M_5200M_change_sink as change_sink  # embedded python module
import CUSTOM_5800M_5200M_receive_para as receive_para  # embedded python module
import time
import threading
...
class CUSTOM_5800M_5200M(gr.top_block):

    def __init__(self, END_1=5870000000, END_2=5350000000, START_1=5715000000, START_2=5150000000, uri='192.168.1.12'):
        gr.top_block.__init__(self, "CUSTOM_5800M_5200M", catch_exceptions=True)
        ...
        if true_en:
            self.iio_fmcomms2_sink_0.set_attenuation(0, 3.5)
        if not true_en:
            self.iio_fmcomms2_sink_0.set_attenuation(1, 12.5)
...
def argument_parser():
    ...
    parser.add_argument(
        "--END-1", dest="END_1", type=intx, default=5870000000,
        help="Set END_1 [default=%(default)r]")
    parser.add_argument(
        "--END-2", dest="END_2", type=intx, default=5350000000,
        help="Set END_2 [default=%(default)r]")
    parser.add_argument(
        "--START-1", dest="START_1", type=intx, default=5715000000,
        help="Set START_1 [default=%(default)r]")
    parser.add_argument(
        "--START-2", dest="START_2", type=intx, default=5150000000,
...
def main(top_block_cls=CUSTOM_5800M_5200M, options=None):
    if options is None:
