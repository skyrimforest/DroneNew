...
import NOR_1400M_change_sink as change_sink  # embedded python module
import NOR_1400M_receive_para as receive_para  # embedded python module
import time
import threading
...
class NOR_1400M(gr.top_block):

    def __init__(self, uri='192.168.1.11'):
        gr.top_block.__init__(self, "NOR_1400M", catch_exceptions=True)
        ...
        self.START_1 = START_1 = 1430000000
        self.END_1 = END_1 = 1444000000
...
def main(top_block_cls=NOR_1400M, options=None):
    if options is None:
