...
import NOR_5800M_change_sink as change_sink  # embedded python module
import NOR_5800M_receive_para as receive_para  # embedded python module
import time
import threading
...
class NOR_5800M(gr.top_block):

    def __init__(self, uri='192.168.1.12'):
        gr.top_block.__init__(self, "NOR_5800M", catch_exceptions=True)
        ...
        self.START_1 = START_1 = 5725000000
        self.END_1 = END_1 = 5829000000
...
def main(top_block_cls=NOR_5800M, options=None):
    if options is None:
