...
import NOR_2400M_change_sink as change_sink  # embedded python module
import NOR_2400M_receive_para as receive_para  # embedded python module
import time
import threading
...
class NOR_2400M(gr.top_block):

    def __init__(self, uri='192.168.1.13'):
        gr.top_block.__init__(self, "NOR_2400M", catch_exceptions=True)
        ...
        self.START_1 = START_1 = 2400000000
        self.END_1 = END_1 = 2476000000
...
def main(top_block_cls=NOR_2400M, options=None):
    if options is None:
