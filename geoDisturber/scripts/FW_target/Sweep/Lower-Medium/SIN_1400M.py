...
class SIN_1400M(gr.top_block):
    ...
    def __init__(self, uri='192.168.1.11'):
        ...
        self.freq_b = freq_b = 1425000000,1445000000
        ...
        self.aaa = aaa = 0
        self.true_en = true_en = change_sink.work(hf_function_probe,aaa, bbb, freq_a, freq_b, atten_a, atten_b,1425000000,0,19.6)[1]
        self.loss = loss = 3
        self.atten = atten = change_sink.work(hf_function_probe,aaa, bbb, freq_a, freq_b, atten_a, atten_b,1425000000,0,19.6)[2]
        self.SW_feq = SW_feq = 25000000
        self.SAMP = SAMP = 25000000
        self.LO_feq = LO_feq = change_sink.work(hf_function_probe,aaa, bbb, freq_a, freq_b, atten_a, atten_b,1425000000,0,19.6)[0]
        self.BW = BW = 25000000
    ...
    def set_hf_function_probe(self, hf_function_probe):
        ...
        self.set_LO_feq(change_sink.work(self.hf_function_probe,self.aaa, self.bbb, self.freq_a, self.freq_b, self.atten_a, self.atten_b,1425000000,0,19.6)[0])
        self.set_atten(change_sink.work(self.hf_function_probe,self.aaa, self.bbb, self.freq_a, self.freq_b, self.atten_a, self.atten_b,1425000000,0,19.6)[2])
        self.set_true_en(change_sink.work(self.hf_function_probe,self.aaa, self.bbb, self.freq_a, self.freq_b, self.atten_a, self.atten_b,1425000000,0,19.6)[1])
