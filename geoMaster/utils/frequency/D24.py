...
import D24_build_FFT as build_FFT  # embedded python module
import D24_epy_block_0 as epy_block_0  # embedded python block
import D24_new_change_sink as new_change_sink  # embedded python module
import sip
import time
import threading
...
class D24(gr.top_block, Qt.QWidget):

    def __init__(self, uri='192.168.1.14', uri_1='192.168.1.15', uri_2='192.168.1.16', uri_3='192.168.1.13'):
        gr.top_block.__init__(self, "caoyang", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("caoyang")
        ...
        self.settings = Qt.QSettings("GNU Radio", "D24")
        ...
        self.CF_TABLE = CF_TABLE =  [(2.415e9, 2.445e9, 2.475e9),(2.415e9, 2.445e9, 2.475e9)]
        ...
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_float, 3072, 'ipc:///tmp/fft.ipc', 100, False, (-1), '', True, True)
...
def main(top_block_cls=D24, options=None):
    if options is None:
